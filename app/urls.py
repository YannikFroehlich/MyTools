...
from .views.core import (
    ...
    nebula_forge_tycoon,
    nebula_forge_tycoon_activity_api,
    nebula_forge_tycoon_load_api,
    nebula_forge_tycoon_save_api,
    obs_dashboard,
    spritkostenrechner,
    stream_deck,
...
urlpatterns = [
    ...
    path('api/snake/score/', snake_score_api, name='snake-score-api'),
    path('nebula-forge-tycoon/', nebula_forge_tycoon, name='nebula-forge-tycoon'),
    path('nebula-forge-tycoon/activity/', nebula_forge_tycoon_activity_api, name='nebula-forge-tycoon-activity-api'),
    path('nebula-forge-tycoon/load/', nebula_forge_tycoon_load_api, name='nebula-forge-tycoon-load-api'),
    path('nebula-forge-tycoon/save/', nebula_forge_tycoon_save_api, name='nebula-forge-tycoon-save-api'),
